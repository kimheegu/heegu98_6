...
CREATE TABLE IF NOT EXISTS `muselabdb`.`ad` (
  ...
  `ad_memo` VARCHAR(200) NULL DEFAULT NULL,
  PRIMARY KEY (`ad_id`))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `muselabdb`.`official_market` (
  ...
  `official_market_content` VARCHAR(500) NULL DEFAULT NULL,
  `official_market_image1` VARCHAR(200) NULL DEFAULT NULL,
  `official_market_image2` VARCHAR(200) NULL DEFAULT NULL,
  `official_market_image3` VARCHAR(200) NULL DEFAULT NULL,
  `official_market_image4` VARCHAR(200) NULL DEFAULT NULL,
  `official_market_image5` VARCHAR(200) NULL DEFAULT NULL,
