...
CREATE TABLE `ad` (
  ...
  `ad_memo` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`ad_id`)
...
CREATE TABLE `buy` (
  ...
  `buy_package_com` varchar(45) DEFAULT NULL,
  `buy_package_num` varchar(45) DEFAULT NULL,
  `buy_product_id` int NOT NULL,
  `buy_user_id` varchar(20) NOT NULL,
  PRIMARY KEY (`buy_id`,`buy_product_id`,`buy_user_id`),
  KEY `fk_buy_official_market1_idx` (`buy_product_id`),
  KEY `fk_buy_user1_idx` (`buy_user_id`),
  CONSTRAINT `fk_buy_official_market1` FOREIGN KEY (`buy_product_id`) REFERENCES `official_market` (`official_market_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE `cart` (
  ...
  KEY `fk_official_market_cart_official_market1_idx` (`cart_product_id`),
  KEY `fk_official_market_cart_user1_idx` (`cart_user`),
  CONSTRAINT `fk_official_market_cart_official_market1` FOREIGN KEY (`cart_product_id`) REFERENCES `official_market` (`official_market_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_official_market_cart_user1` FOREIGN KEY (`cart_user`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mk_comment` (
  ...
  CONSTRAINT `fk_mk_comment_market1` FOREIGN KEY (`mk_comment_market`) REFERENCES `market` (`market_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_mk_comment_user1` FOREIGN KEY (`mk_comment_user`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `official_market`
--

DROP TABLE IF EXISTS `official_market`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `official_market` (
  `official_market_id` int NOT NULL AUTO_INCREMENT,
  `official_market_title` varchar(50) NOT NULL,
  `official_market_content` varchar(500) DEFAULT NULL,
  `official_market_image1` varchar(200) DEFAULT NULL,
  `official_market_image2` varchar(200) DEFAULT NULL,
  `official_market_image3` varchar(200) DEFAULT NULL,
  `official_market_image4` varchar(200) DEFAULT NULL,
  `official_market_image5` varchar(200) DEFAULT NULL,
...
--
-- Dumping data for table `official_market`
--

LOCK TABLES `official_market` WRITE;
/*!40000 ALTER TABLE `official_market` DISABLE KEYS */;
/*!40000 ALTER TABLE `official_market` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-07-18  9:16:12
