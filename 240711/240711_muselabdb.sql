...
CREATE TABLE `market` (
  ...
  `mk_title` varchar(50) NOT NULL,
  `mk_content` varchar(500) NOT NULL,
  `mk_image1` varchar(200) DEFAULT NULL,
  `mk_image2` varchar(200) DEFAULT NULL,
  `mk_image3` varchar(200) DEFAULT NULL,
  `mk_image4` varchar(200) DEFAULT NULL,
  `mk_image5` varchar(200) DEFAULT NULL,
  `mk_price` int NOT NULL,
  `mk_condition` varchar(20) DEFAULT NULL,
  `mk_category` varchar(20) NOT NULL,
  `mk_user_id` varchar(20) NOT NULL,
  `mk_views` int NOT NULL,
  `mk_like` int NOT NULL,
  PRIMARY KEY (`mk_id`,`mk_user_id`),
  KEY `fk_market_user_idx` (`mk_user_id`),
  CONSTRAINT `fk_market_user` FOREIGN KEY (`mk_user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `mk_comment` (
  ...
  CONSTRAINT `fk_mk_comment_market1` FOREIGN KEY (`mk_comment_market`) REFERENCES `market` (`mk_id`),
...
-- Dump completed on 2024-07-11 20:55:57
