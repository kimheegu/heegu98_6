...
CREATE TABLE IF NOT EXISTS `muselabdb`.`ad` (
  ...
  `ad_memo` VARCHAR(1000) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `muselabdb`.`admin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `muselabdb`.`admin` (
...
CREATE TABLE IF NOT EXISTS `muselabdb`.`buy` (
  ...
  `buy_package_com` VARCHAR(45) NULL DEFAULT NULL,
  `buy_package_num` VARCHAR(45) NULL DEFAULT NULL,
  ...
  INDEX `fk_buy_market1_idx` (`buy_market_id` ASC) VISIBLE,
  CONSTRAINT `fk_buy_user1`
    FOREIGN KEY (`buy_user_id`)
    REFERENCES `muselabdb`.`user` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_buy_market1`
    FOREIGN KEY (`buy_market_id`)
...
-- -----------------------------------------------------
-- Table `muselabdb`.`mk_review`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `muselabdb`.`mk_review` (
  `mk_review_id` INT NOT NULL AUTO_INCREMENT,
  `mk_review_content` VARCHAR(10000) NOT NULL,
  ...
  INDEX `fk_mk_comment_market1_idx` (`mk_review_market` ASC) VISIBLE,
  INDEX `fk_mk_comment_user1_idx` (`mk_review_user` ASC) VISIBLE,
  CONSTRAINT `fk_mk_comment_market1`
    FOREIGN KEY (`mk_review_market`)
    REFERENCES `muselabdb`.`market` (`market_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_mk_comment_user1`
    FOREIGN KEY (`mk_review_user`)
    REFERENCES `muselabdb`.`user` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `muselabdb`.`notice` (
  ...
  `notice_image1` VARCHAR(200) NULL,
  `notice_image2` VARCHAR(200) NULL,
  `notice_image3` VARCHAR(200) NULL,
  `notice_image4` VARCHAR(200) NULL,
  `notice_image5` VARCHAR(200) NULL,
  `notice_views` INT NOT NULL,
  `notice_admin_id` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`notice_id`, `notice_admin_id`),
  INDEX `fk_notice_admin1_idx` (`notice_admin_id` ASC) VISIBLE,
  CONSTRAINT `fk_notice_admin1`
    FOREIGN KEY (`notice_admin_id`)
    REFERENCES `muselabdb`.`admin` (`admin_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `muselabdb`.`article`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `muselabdb`.`article` (
  `article_id` INT NOT NULL,
  `article_title` VARCHAR(100) NOT NULL,
  `article_content` VARCHAR(1000) NOT NULL,
  `article_image1` VARCHAR(200) NULL,
  `article_image2` VARCHAR(200) NULL,
  `article_image3` VARCHAR(200) NULL,
  `article_image4` VARCHAR(200) NULL,
  `article_image5` VARCHAR(200) NULL,
  `article_views` INT NOT NULL,
  `article_admin_id` VARCHAR(30) NOT NULL,
  PRIMARY KEY (`article_id`, `article_admin_id`),
  INDEX `fk_article_admin1_idx` (`article_admin_id` ASC) VISIBLE,
  CONSTRAINT `fk_article_admin1`
    FOREIGN KEY (`article_admin_id`)
    REFERENCES `muselabdb`.`admin` (`admin_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
